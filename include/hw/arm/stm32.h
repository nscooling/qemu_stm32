 ...
 * frequency. */
void stm32_rcc_set_periph_clk_irq(Stm32Rcc *s, stm32_periph_t periph,
                                  qemu_irq periph_irq);
...
void stm32_init(ram_addr_t flash_size, ram_addr_t ram_size,
                ...
                uint32_t osc32_freq, const char *cpu_model);
